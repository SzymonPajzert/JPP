...
instance Print Exp where
  prt i e = case e of
    ...
    ESmal exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "<"), prt 3 exp2])
    EEq exp1 exp2 -> prPrec i 2 (concatD [prt 3 exp1, doc (showString "="), prt 3 exp2])
    EAnd exp1 exp2 -> prPrec i 0 (concatD [prt 2 exp1, doc (showString "&&"), prt 3 exp2])
    EOr exp1 exp2 -> prPrec i 0 (concatD [prt 1 exp1, doc (showString "||"), prt 2 exp2])
